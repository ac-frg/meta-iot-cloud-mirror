...
SRC_URI = "\
    ...
    git://github.com/googleapis/googleapis.git;protocol=https;branch=master;rev=8cd3749f4b98f2eeeef511c16431979aeb3a6502;destsuffix=${UNPACKDIR}/${BB_GIT_DEFAULT_DESTSUFFIX}/external/googleapis/src/googleapis_download;name=googleapis \
